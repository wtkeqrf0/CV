...
\resumeSubheading
{Backend Golang developer (junior)\emph{}}{2023 January -- 2023 July}
{AO MTT}{Moscow, Russia}
\resumeItemListStart
\resumeItem{Wrote clean and testable code}
\resumeItem{Documented written code by OpenAPI}
\resumeItem{Added new features to the API}
\resumeItem{Offered my ideas on writing new features}
\resumeItem{Actively interacted with other programmers}
\resumeItem{Developed SQL and NoSQL queries}
\resumeItemListEnd
