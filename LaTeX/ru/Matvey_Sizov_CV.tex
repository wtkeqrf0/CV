...
\resumeSubheading
{Backend Golang разработчик (junior)\emph{}}{2023 Январь -- 2023 Июль}
{АО МТТ}{Москва, Россия}
\resumeItemListStart
\resumeItem{Писал чистый, тестируемый код}
\resumeItem{Документировал написанный код с помощью OpenAPI}
\resumeItem{Добавлял новые фичи к API}
\resumeItem{Предлагал свои идеи по написанию новых фич}
\resumeItem{Активно взаимодействовал с другими программистами}
\resumeItem{Разрабатывал SQL и NoSQL запросы}
\resumeItemListEnd
